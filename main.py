...
# this is a testing script to print an image to a Phomemo M02 printer
# The code was copied from https://github.com/vivier/phomemo-tools and adapted for my usecase
